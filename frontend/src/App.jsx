...
const App = () => {
  ...
  return (
    <>
      ...
      <div className="flex">
        {isAuthenticated && (<SideBar sidebarCollapsed={sidebarCollapsed} toggleSidebar={toggleSidebar} onLogoutClick={() => setIsLogoutModalOpen(true)}/>)}

        <div className="flex-1">
          {isAuthenticated && (<TopBar onLogoutClick={() => setIsLogoutModalOpen(true)} />)}

          <div className={`flex-1 ${sidebarCollapsed && isAuthenticated ? "ml-5" : ""}`}>
            <Routes>

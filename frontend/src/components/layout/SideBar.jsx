    ...
    >
      ...
      <div className="p-6 border-b border-gray-700">
        <div className="flex items-center gap-3">
          ...
          <span
            className={`text-2xl font-bold bg-linear-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent duration-300 transition-all ${sidebarCollapsed
      ...
      <div className="flex-1 p-4 space-y-2 mt-2">
        {menuItems.map((item) => (
          <NavLink
            ...
            to={item.key}
            className={({ isActive }) =>
              `flex items-center gap-4 px-4 py-3 transition-all duration-200 group hover:bg-linear-to-r hover:from-blue-900/30 hover:to-purple-900/30 hover:shadow-md ${isActive
          ...
          >
            ...
            <span
              className={`font-medium transition-all duration-300 ${sidebarCollapsed
                  ? "opacity-0 w-0 overflow-hidden"
                  : "opacity-100"
                }`}
            >
      ...
      <div className="p-4 border-t border-gray-700 space-y-2">
        <NavLink
          to="/profile"
          className={({ isActive }) =>
            `flex items-center gap-4 px-4 py-3  transition-all duration-200 group hover:bg-gray-800/50 ${isActive ? "bg-gray-800/50" : ""
            }`
          }
        >
          ...
          <span
            className={`font-medium transition-all duration-300 ${sidebarCollapsed ? "opacity-0 w-0 overflow-hidden" : "opacity-100"
              }`}
          >
            My Profile
          </span>
